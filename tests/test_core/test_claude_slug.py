...
def test_posix_path():
    assert _claude_project_slug_from_abs("/Users/joy/IdeaProjects/cgh") == "-Users-joy-IdeaProjects-cgh"
...
def test_windows_path_matches_real_claude_dir():
    ...
    assert _claude_project_slug_from_abs(win) == "C--Users-jn532e9l-IdeaProjects-landing-zone"
